...
pipeline {
	...
	environment {
		...
		GITHUB_URL ='https://github.com/microchip-pic-avr-examples/attiny1627-force-sensitive-resistor-with-12-bit-adc.git'
		BITBUCKET_URL = 'https://bitbucket.microchip.com/scm/ebe/attiny1627-force-sensitive-resistor-with-12-bit-adc.git'
